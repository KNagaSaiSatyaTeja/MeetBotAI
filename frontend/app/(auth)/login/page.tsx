    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white/90 backdrop-blur rounded-xl shadow-lg p-8 w-full max-w-md">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button disabled={loading} className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-md py-2 font-medium disabled:opacity-60">{loading ? 'Signing in...' : 'Sign In'}</button>
        </form>
